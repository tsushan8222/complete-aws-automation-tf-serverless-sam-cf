...
resource "aws_codebuild_project" "this" {
  ...
  # Runtimes and Versions https://docs.aws.amazon.com/codebuild/latest/userguide/runtime-versions.html
...
phases:
  ...
  pre_build:
    commands:
      ...
      - export TERRAFORM_STATE_PATH=$(echo "$ENV/$REPO_NAME/$APPLICATION_ROLE" | awk '{print tolower($0)}' )
