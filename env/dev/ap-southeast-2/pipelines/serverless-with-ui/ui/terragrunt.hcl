...
locals {
  ...
  local_env = [
    {
      name  = "REACT_APP_ENV"
      value = upper(local.global_environment_vars.locals.environment)
      type  = "PLAINTEXT"
    },
    {
    ...
    {
      name  = "REACT_APP_GOOGLE_ANALYTICS_CATEGORY"
      value = ""
      type  = "PLAINTEXT"
    },
    {
      name  = "REACT_APP_service_API_URL"
      value = "https://simple-form-api.uat.example.come"
      type  = "PLAINTEXT"
    },
    {
      name  = "REACT_APP_GOOGLE_TAG_MANAGER_ID"
      value = ""
      type  = "PLAINTEXT"
    }
  ]
