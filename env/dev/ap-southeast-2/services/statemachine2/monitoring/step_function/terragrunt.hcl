...
locals {
  ...
  event_rule_name         = "${local.global_environment_vars.locals.environment}factfind_stepfunction_event_rule"
  application_name        = "${local.global_environment_vars.locals.environment}factfind_stepfunction_notification"
}
inputs = {
  ...
  external_cc_group_email = "tech@homeloanexperts.com.au"
  step_function_arns      = ["arn:aws:states:ap-southeast-2:123456789:stateMachine:statemachine2"]
}
